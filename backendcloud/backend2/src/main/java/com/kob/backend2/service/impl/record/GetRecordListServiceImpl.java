package com.kob.backend2.service.impl.record;
...
import com.kob.backend2.service.record.GetRecordListService;
...
public class GetRecordListServiceImpl implements GetRecordListService {
    ...
    public JSONObject getList(Integer page) {
        ...
        queryWrapper.orderByDesc("id"); // desc 按降序排序
        ...
        resp.put("records_count", recordMapper.selectCount(null)); // 无条件返回总记录数
        return resp;
    }
}

...
public class Game extends Thread{
    ...
    private String getInput(Player player){
       ...
       return getMaoString() + "#" + me.getSx() + "#" + me.getSy() + "#(" + me.getStepsString() +")#" + you.getSx() + "#" + you.getSy() + "#(" + you.getStepsString() + ")#";
    }
    ...
    private void sendResult(){//向两个Clinet公布结果
        JSONObject resp = new JSONObject();
